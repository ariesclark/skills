...
when_to_use: >-
  Use when writing or reviewing schemas, changesets, migrations, or Repo/query code. Triggers: Ecto, changeset, cast_assoc, Repo, migration, Ecto.Multi, preload, N+1.
---
